...
export const CalendarHeader = ({ date, selectedView, onSelectionChange, viewOptions, onClickPrev, onClickNext, onClickToday, showAddEventButton = false, onAddEvent }: CalendarHeaderProps) => {
    const renderPeriod = () => {
